        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <p class="mb-0 text-muted text-medium">Design by Mark Stepaniuk 2022</p>
                </div>
...
<script src="../../orderLab/template/js/vendor/OverlayScrollbars.min.js"></script>
<script src="../../orderLab/template/js/vendor/autoComplete.min.js"></script>
<script src="../../orderLab/template/js/vendor/clamp.min.js"></script>
<script src="../../orderLab/template/js/cs/scrollspy.js"></script>
<script src="../../orderLab/template/js/vendor/select2.full.min.js"></script>
<script src="../../orderLab/template/js/vendor/datepicker/bootstrap-datepicker.min.js"></script>
<script src="../../orderLab/template/js/vendor/datepicker/locales/bootstrap-datepicker.es.min.js"></script>
<script src="../../orderLab/template/js/vendor/jquery.validate/jquery.validate.min.js"></script>
<script src="../../orderLab/template/js/vendor/jquery.validate/additional-methods.min.js"></script>
<!-- Vendor Scripts End -->

<!-- Template Base Scripts Start -->
<script src="../../orderLab/template/font/CS-Line/csicons.min.js"></script>
<script src="../../orderLab/template/js/base/helpers.js"></script>
<script src="../../orderLab/template/js/base/globals.js"></script>
<script src="../../orderLab/template/js/base/nav.js"></script>
<script src="../../orderLab/template/js/base/search.js"></script>
<script src="../../orderLab/template/js/base/settings.js"></script>
<script src="../../orderLab/template/js/base/init.js"></script>
<!-- Template Base Scripts End -->
<!-- Page Specific Scripts Start -->
<script src="../../orderLab/template/js/forms/genericforms.js"></script>
<script src="../../orderLab/template/js/common.js"></script>
<script src="../../orderLab/template/js/scripts.js"></script>
